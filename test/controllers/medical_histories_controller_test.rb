...
class MedicalHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_history" do
    assert_difference('MedicalHistory.count') do
      post medical_histories_url, params: { medical_history: { alergies: @medical_history.alergies, diseases: @medical_history.diseases, medicines: @medical_history.medicines, patient_id: @medical_history.patient_id, size: @medical_history.size, user_id: @medical_history.user_id, weight: @medical_history.weight } }
    end
  ...
  test "should update medical_history" do
    patch medical_history_url(@medical_history), params: { medical_history: { alergies: @medical_history.alergies, diseases: @medical_history.diseases, medicines: @medical_history.medicines, patient_id: @medical_history.patient_id, size: @medical_history.size, user_id: @medical_history.user_id, weight: @medical_history.weight } }
